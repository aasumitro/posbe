        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <aside className="mx-4 grid grid-cols-2 gap-12 p-8">
            ...
            <div className="w-full space-y-4">
              <VariantGroups control={form.control} units={units?.data} />
            </div>
          </aside>
        </form>
      </Form>
...
// Component for variants inside a group
...
function VariantGroups({ control, units }: VariantGroupsProps) {
    ...
    <div className="w-full space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button
          variant="ghost"
          type="button"
          onClick={() => addGroup({ type: "", variants: [] })}
        >
