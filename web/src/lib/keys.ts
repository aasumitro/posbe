export const KEYS = {
  UI_AUTH_TOKEN: "ui:auth:token",
  UI_USER_PROFILE: "ui:user:profile",

  DISPLAY_USER_DETAIL_SHEET: "display_user_detail_sheet",
  DISPLAY_LOGOUT_MODAL: "display_logout_dialog",
