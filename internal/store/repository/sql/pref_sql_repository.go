...
type PrefSQLRepository struct {
	Db *sql.DB
}

func (repo PrefSQLRepository) Find(ctx context.Context, key string) (pref *model.StoreSetting, err error) {
...
func (repo PrefSQLRepository) All(ctx context.Context) (prefs *model.StoreSetting, err error) {
...
func (repo PrefSQLRepository) Update(ctx context.Context, key, value string) (prefs *model.StoreSetting, err error) {
...
func NewPrefSQLRepository() model.IStorePrefRepository {
	return &PrefSQLRepository{Db: config.PostgresPool}
}
