...
func (handler prefHandler) fetch(ctx *gin.Context) {
...
func (handler prefHandler) update(ctx *gin.Context) {
...
func NewPreferenceHandler(svc model.IStorePrefService, router gin.IRoutes) {
	handler := prefHandler{svc: svc}
