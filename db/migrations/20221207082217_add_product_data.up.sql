...
VALUES (1, 'size', 's', 'small', 4, 250, 12),
       (1, 'size', 'm', 'medium', 4, 480, 14),
       (1, 'size', 'l', 'large', 4, 650,16),
       (1, 'size', 'xl', 'extra large', 5, 1.5, 18),
       (2, 'size', 'half', 'half portion', 1, 250, 25),
       (2, 'size', 'normal', 'normal portion', 1, 500, 50);
